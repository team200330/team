	                ...
	                <div class="card-body">
	                 <form id="detail-form2" role="form" action="detailUpdate" method="post">
	                  ...
	                  <div class="form-group" style="display: inline-block;">
	                    ...
	                    <input id="de_managerEmail" name="managerEmail" class="form-control" type="text" value="" readonly="readonly">
	                  </div>
            		</form>
                     ...
                     <form id="feedback_write_form2" method="post" action="/team/addProjectMember">
                       <label for="exampleInputEmail1">프로젝트 멤버(선택사항)</label> <span style="color:#a0a0a0;">&nbsp;&nbsp;같은 워크스페이스에 있는 사람을 프로젝트에 초대하세요.</span>
			            ...
			            <div class="modal-body" style="padding:10px;">
			              <div id="mem2"></div>
			              <input id="_mem_input2" style="margin-top:10px; width:100%;height:30px;border:1px solid #17a2b8;padding:10px;margin-bottom:10px;"type="text" placeholder="이름 혹은 이메일로 찾기">
			            	<div id="workspace_mem2" style="margin-top:10px; margin-bottom:20px; overflow: auto;  height: 130px;">
					  ...
					  <div class="form-group">
		              	...
		              	<form id="deleted" method="post" action="/team/project/deleted">
		              		<input  style="display:none" id="de_deleted" type="text" name="deleted"  value=""/>
		              	</form>
