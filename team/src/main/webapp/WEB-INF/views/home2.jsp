...
<html>
  <head>
    ...
    <link rel="stylesheet" href="/team/resources/main/fonts/icomoon/style.css">

    <link rel="stylesheet" href="/team/resources/main/css/bootstrap.min.css">
    <link rel="stylesheet" href="/team/resources/main/css/jquery-ui.css">
    <link rel="stylesheet" href="/team/resources/main/css/owl.carousel.min.css">
    <link rel="stylesheet" href="/team/resources/main/css/owl.theme.default.min.css">
    <link rel="stylesheet" href="/team/resources/main/css/owl.theme.default.min.css">

    <link rel="stylesheet" href="/team/resources/main/css/jquery.fancybox.min.css">

    <link rel="stylesheet" href="/team/resources/main/css/bootstrap-datepicker.css">

    <link rel="stylesheet" href="/team/resources/main/fonts/flaticon/font/flaticon.css">

    <link rel="stylesheet" href="/team/resources/main/css/aos.css">

    <link rel="stylesheet" href="/team/resources/main/css/style.css">
  ...
  <div class="site-wrap">
          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li><a href="/team/account/login.action">Login</a></li>
                <li><a href="/team/account/register.action">Sign Up</a></li>
    ...
    <div class="site-blocks-cover overlay" style="background-image: url(/team/resources/main/images/hero_2.jpg);" data-aos="fade" id="home-section">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6 mb-5" data-aos="fade-up" data-aos-delay="">
            ...
            <img src="/team/resources/main/images/img_2.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid">
            </figure>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="">
            <div class="team-member">
              <figure>
                ...
                <img src="/team/resources/main/images/person_1.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="p-3">
          ...
          <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="100">
            <div class="team-member">
              <figure>
                ...
                <img src="/team/resources/main/images/person_2.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="p-3">
                <h3>Dave Simpson</h3>
          ...
          <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="200">
            <div class="team-member">
              <figure>
                ...
                <img src="/team/resources/main/images/person_3.jpg" alt="Image" class="img-fluid">
              </figure>
              <div class="p-3">
                <h3>Ben Thompson</h3>
                <span class="position">Bank Teller</span>
 ...
 -->
        ...
        <div class="row align-items-lg-center" >
          <div class="col-lg-6 mb-5" data-aos="fade-up" data-aos-delay="">
            ...
            <div class="owl-carousel slide-one-item-alt">
              <img src="/team/resources/main/images/img_1.jpg" alt="Image" class="img-fluid">
              <img src="/team/resources/main/images/img_2.jpg" alt="Image" class="img-fluid">
              <img src="/team/resources/main/images/img_3.jpg" alt="Image" class="img-fluid">
            </div>
    ...
    <!-- <section class="site-section" id="about-section">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6 mb-5" data-aos="fade-up" data-aos-delay="">
            <figure class="circle-bg">
            <img src="/team/resources/main/images/img_4.jpg" alt="Free Website Template by Free-Template.co" class="img-fluid">
            </figure>
          </div>
          <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="100">
  ...
  <script src="/team/resources/main/js/jquery-3.3.1.min.js"></script>
  <script src="/team/resources/main/js/jquery-ui.js"></script>
  <script src="/team/resources/main/js/popper.min.js"></script>
  <script src="/team/resources/main/js/bootstrap.min.js"></script>
  <script src="/team/resources/main/js/owl.carousel.min.js"></script>
  <script src="/team/resources/main/js/jquery.countdown.min.js"></script>
  <script src="/team/resources/main/js/jquery.easing.1.3.js"></script>
  <script src="/team/resources/main/js/aos.js"></script>
  <script src="/team/resources/main/js/jquery.fancybox.min.js"></script>
  <script src="/team/resources/main/js/jquery.sticky.js"></script>
  <script src="/team/resources/main/js/isotope.pkgd.min.js"></script>

  
  <script src="/team/resources/main/js/main.js"></script>
